...
overcomes numerous shortcomings of previous analyses. 
Our analysis improvements stem primarily from our 
directly populating mock galaxy catalogs into a cosmological simulation, 
...
modeling, such as scale-dependent halo bias and halo exclusion, are treated exactly.  
Our approach also provides a natural framework for studying models of assembly bias, 
since we can use the exact clustering properties of simulated halos as a function of 
any arbitrary halo properties in the catalog. With direct mock population, 
systematic uncertainty in the model is limited to 
the sample variance of the simulated box, 
errors related to insufficient numerical resolution, 
and numerical inaccuracies of halo-finding (e.g., over-merging). 


In addition to improvements from direct mock population, 
...
Chains used in \citet{zehavi_etal11} did not sufficiently sample the 
posterior distribution (Z. Zheng \& I. Zehavi, private communication).  Therefore,
...
analyses. Look for the purple banana\footnote{'til they put us in the truck.} in the upper-left panel of 
Fig.~\ref{fig:Mr20triangle}. This panel illustrates that the 
parameters $\log (M_1)$ and $\alpha$ are degenerate with each other and positively 
...
Foundation through grant AST 1516962. APH is funded through his own 
awesomeness.
