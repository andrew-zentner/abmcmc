...
the HODs from the samples of the posterior distribution at each mass bin. For 
any individual sample, the values of the HOD at each mass point are correlated. 
}
