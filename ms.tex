...
that the tighter constraints quoted by \citet{zehavi_etal11} must be an error. We have confirmed with a subset of 
the authors of \citet{zehavi_etal11} that the number of MCMC samples they included in their analysis was 
