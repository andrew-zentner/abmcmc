...
there is little reason to suspect that all environmental factors are determined by a single halo property. 
...
have virial masses that may be smaller than the masses of other halos that host similar galaxies \citet{dalal_etal08}. 
...
sense of assembly bias suggested by our analysis. {\bf APH: the following sentence kind of dangles.} Galaxy assembly bias induced by these 
...
the finer-grained causes for this correlation. 
...
This implies that {\em it is not possible to reliably constrain a finer-grained physical picture using 
projected clustering and number density alone.} 
In order to constrain models that are more complex than simple empirical models 
such as the Decorated HOD,
it is necessary to leverage additional constraining power of 
