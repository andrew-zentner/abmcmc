...
\citet{zehavi_etal11}. As is evident in Figure~\ref{fig:Mr20triangle}, $\log (M_{\rm min})$ and $\sigma_{\log M}$ 
share a relatively narrow degeneracy. This degeneracy is largely induced by the measured number density of 
the sample. Increasing $\log (M_{\rm min})$ decreases galaxy number density, but this can be compensated by 
an increase in $\sigma_{\log M}$, which places galaxies in a fraction of the considerably more numerous halos 
with masses less than $M_{\rm min}$.

We do not show our constraints on $\log (M_0)$ as they are very poor in all cases, 
...
The one-dimensional marginalized constraints on all parameters form these analyses 
...
range, we quote an upper or lower limit on the parameter. 
